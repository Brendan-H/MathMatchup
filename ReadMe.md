...
6. (optional) If you want, you can skip running the frontend and simply visit [The MathMatchup Website](https://mathmatchupapp.brendanharan.com) and it will work with your locally running backend
...
5. Note: Visiting the [MathMatchup Website](https://mathmatchup.brendanharan.com) will also work if the backend is running. You can still view static content without the backend.
