 ...
 * Current File (GameController.java) Last Modified on 2/9/25, 2:10 PM
 *
 */
...
import com.brendanharan.mathmatchupbackend.games.analytics.GameAnalyticsDTO;
...
public class GameController {
    ...
    public ResponseEntity<GameAnalyticsDTO> getGameAnalytics(@PathVariable String gameCode) {
        try {
            GameAnalytics gameAnalytics = gameAnalyticsRepository.findByGame_GameCode(gameCode);
            if (gameAnalytics == null) {
                return ResponseEntity.notFound().build();
            }

            GameAnalyticsDTO dto = new GameAnalyticsDTO(gameAnalytics);
