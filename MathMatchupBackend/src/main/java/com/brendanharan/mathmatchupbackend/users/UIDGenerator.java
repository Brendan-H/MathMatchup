 ...
 * Current File (UIDGenerator.java) Last Modified on 9/13/24, 11:21 AM
 *
 */
...
// this is meant to mimic the UIDs generated by Firebase to ensure consistency across the backend and frontend since
// the frontend uses firebase to generate UIDs for parents but backend uses this class to generate UIDs for teachers
